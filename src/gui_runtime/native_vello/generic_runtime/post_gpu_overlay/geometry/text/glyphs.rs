pub(super) fn glyph_rows(ch: char) -> Option<[u8; 7]> {
    Some(match ch {
        'A' => [
        ...
        ';' => [
            0b00000, 0b01100, 0b01100, 0b00000, 0b01100, 0b01000, 0b10000,
        ],
        '-' => [
...
mod tests {
    ...
    #[test]
    fn glyph_rows_preserve_lowercase_shapes_for_overlay_tooltips() {
    ...
    #[test]
    fn glyph_rows_support_tooltip_punctuation() {
        for ch in [':', ',', ';', '+', '/'] {
            assert!(glyph_rows(ch).is_some(), "expected glyph for {ch}");
        }
    }
}
