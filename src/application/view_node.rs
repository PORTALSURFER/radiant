...
pub struct ViewNode<Message> {
    ...
    scroll_edit: Option<crate::runtime::ScrollEditMessageMapper<Message>>,
    pub(in crate::application) scroll_policy: Option<crate::layout::ScrollPolicy>,
    pub(in crate::application) initial_offset: Option<Vector2>,
    pub(in crate::application) controlled_offset: Option<crate::layout::Controlled<Vector2>>,
    pub(in crate::application) scroll_request: Option<crate::layout::ScrollRequest>,
