...
pub(crate) struct StateOverlayFingerprint {
    ...
    pub hovered_folder_pane: Option<crate::sempal_app::FolderPaneIdModel>,
...
pub(crate) struct ModalOverlayFingerprint {
    ...
    pub source_context_menu_pane: Option<crate::sempal_app::FolderPaneIdModel>,
...
pub(crate) struct ChromeMotionOverlayFingerprint {
    ...
    pub hovered_browser_playback_age_filter_chip: Option<crate::sempal_app::PlaybackAgeFilterChip>,
