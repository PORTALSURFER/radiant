...
`update_panel_resize_drag` for splitter-driven pane resizing. Host applications
map product-specific navigation, workspace, project, or asset concepts onto
these reusable panel structures.
