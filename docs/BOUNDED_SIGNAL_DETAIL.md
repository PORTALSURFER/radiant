...
pans reuse a tile instead of continuously creating products. If no tile is
ready, is not admissible, or does not cover the request, rendering uses the
overview.
...
Logical native GPU handle residency is limited to 128 MiB.
