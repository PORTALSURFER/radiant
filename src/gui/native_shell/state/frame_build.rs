...
fn status_progress_label(model: &AppModel) -> String {
...
fn status_progress_counter(model: &AppModel) -> String {
    if model.progress_overlay.cancel_requested {
...
fn status_progress_text_rects(segment: Rect, sizing: SizingTokens) -> (Rect, Rect) {
...
fn status_progress_track_rect(segment: Rect, sizing: SizingTokens) -> Rect {
...
fn status_progress_fill_rect(track_rect: Rect, model: &AppModel) -> Option<Rect> {
