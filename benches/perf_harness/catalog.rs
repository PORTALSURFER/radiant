...
const DIRTY_RELAYOUT_COUNTERS: &[&str] = &[
    "dirty_mark_count",
    "relayout_count",
    "allocation_sensitive_work_count",
];
...
macro_rules! perf_scenario_catalog {
    ($apply:ident $($prefix:tt)*) => {
        $apply! {
            ...
            ("layout_dirty_virtual_cache_10k", "layout", "scene_cache", DIRTY_RELAYOUT_COUNTERS, LAYOUT_ITERATIONS, layout_scenarios::dirty_virtual_cache_10k),
            ...
            ("runtime_component_local_geometry_3200", "runtime_surface", "scene_cache", &["layout_node_visit_count"], RUNTIME_ITERATIONS, runtime_scenarios::component_local_geometry),
