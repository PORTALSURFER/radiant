...
pub mod layout {
    pub use crate::gui::layout_core::{
        ...
        LayoutOutput, LayoutState, LayoutStats, LayoutTargetIdentity, MainAlign, NodeId,
        OverflowInfo, OverflowPolicy, Point, Rect, SizeModeCross, SizeModeMain, SlotChild,
        SlotChildParts, SlotParams, SplitPaneAxis, SplitPaneCollapsePolicy, SplitPanePolicy,
        StackedRowRectsParts, SwitchBreakpoint, VIRTUAL_LAYOUT_MAX_QUERY_ENTRIES, Vector2,
        VirtualLayoutBoundsConfidence, VirtualLayoutBudget, VirtualLayoutCoordinateSpace,
        VirtualLayoutDeferredReason, VirtualLayoutDiagnostic, VirtualLayoutDiagnosticCode,
        VirtualLayoutDiagnostics, VirtualLayoutExtent, VirtualLayoutExtentCandidate,
        VirtualLayoutExtentKind, VirtualLayoutFenceField, VirtualLayoutFenceFields,
        VirtualLayoutInputError, VirtualLayoutItem, VirtualLayoutItemCandidate,
        VirtualLayoutItemKey, VirtualLayoutItemKeyCandidate, VirtualLayoutOverscan,
        VirtualLayoutPolicy, VirtualLayoutPolicyDecision, VirtualLayoutPolicyIdentity,
        VirtualLayoutQueryExecutor, VirtualLayoutQueryFence, VirtualLayoutQueryInput,
        VirtualLayoutQueryInputParts, VirtualLayoutQueryOutcome, VirtualLayoutQueryResult,
        VirtualLayoutQuerySink, VirtualLayoutSinkError, VirtualLayoutUnavailableReason,
        VirtualLayoutVisibility, VirtualWindowInfo, VirtualizationAxis, VirtualizationPolicy,
        WidgetNode, WidgetNodeParts, WrapPolicy, fixed_width_group_width,
