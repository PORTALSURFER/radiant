use super::super::{
    TreeGuideOverlay, TreeGuideRow, TreeGuideSegment, TreeGuideStyle, tree_guide_segments,
};
use crate::{gui::types::Rect, widgets::Widget};

const ROW_HEIGHT: f32 = 23.0;
const INDENT: f32 = 10.0;
const GUIDE_COLOR: crate::gui::types::Rgba8 = crate::gui::types::Rgba8 {
    r: 255,
    g: 126,
    b: 64,
    a: 152,
