...
| Broad end-to-end target coverage | ~94.5% |

| Category | Estimate |
| --- | ---: |
| Public API and module boundaries | 99.5% |
| Declarative model, identity, reconciliation | 84% |
| Input, provenance, and edit lifecycle | 99% |
| Layout, composition, virtualization | 76% |
...
| Examples, documentation, and CI guardrails | 98.5% |
