...
pub(super) fn action_slug(action: &UiAction) -> String {
    match action {
        ...
        UiAction::OpenAudioOutputHostPicker => "open_audio_output_host_picker",
        UiAction::OpenAudioOutputDevicePicker => "open_audio_output_device_picker",
        UiAction::OpenAudioOutputSampleRatePicker => "open_audio_output_sample_rate_picker",
        UiAction::OpenAudioInputHostPicker => "open_audio_input_host_picker",
        UiAction::OpenAudioInputDevicePicker => "open_audio_input_device_picker",
        UiAction::OpenAudioInputSampleRatePicker => "open_audio_input_sample_rate_picker",
        UiAction::SetAudioOutputHost { .. } => "set_audio_output_host",
        UiAction::SetAudioOutputDevice { .. } => "set_audio_output_device",
        UiAction::SetAudioOutputSampleRate { .. } => "set_audio_output_sample_rate",
        UiAction::SetAudioInputHost { .. } => "set_audio_input_host",
        UiAction::SetAudioInputDevice { .. } => "set_audio_input_device",
        UiAction::SetAudioInputSampleRate { .. } => "set_audio_input_sample_rate",
        ...
        UiAction::FinishBrowserSampleDrag => "finish_browser_sample_drag",
        ...
        UiAction::SetBrowserTagSidebarInput { .. } => "set_browser_tag_sidebar_input",
        UiAction::CommitBrowserTagSidebarInput => "commit_browser_tag_sidebar_input",
        UiAction::ClearBrowserTagSidebarUserTag => "clear_browser_tag_sidebar_user_tag",
        UiAction::SetBrowserSidebarLooped { .. } => "set_browser_sidebar_looped",
        UiAction::SetBrowserSidebarSoundType { .. } => "set_browser_sidebar_sound_type",
