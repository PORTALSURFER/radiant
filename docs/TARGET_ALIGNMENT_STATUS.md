...
| Broad end-to-end target coverage | ~74.91% (~75%) |

| Category | Estimate |
| --- | ---: |
| Public API and module boundaries | 80% |
| Declarative model, identity, reconciliation | 70% |
| Input, provenance, and edit lifecycle | 82% |
| Layout, composition, virtualization | 96% |
| Text, focus, and selection | 63% |
| Numeric controls | 49% |
| Runtime, effects, and scheduling | 95% |
...
| Examples, documentation, and CI guardrails | 75% |
