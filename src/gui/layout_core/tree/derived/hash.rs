...
fn floating_horizontal_overflow_code(
    value: crate::gui::layout_core::model::FloatingLayerHorizontalOverflow,
) -> u8 {
    match value {
        crate::gui::layout_core::model::FloatingLayerHorizontalOverflow::Fixed => 0,
        crate::gui::layout_core::model::FloatingLayerHorizontalOverflow::ClampToViewport => 1,
    }
}
