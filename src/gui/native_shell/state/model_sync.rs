...
impl NativeShellState {
    ...
    pub(crate) fn chrome_motion_overlay_fingerprint(&self) -> ChromeMotionOverlayFingerprint {
        ChromeMotionOverlayFingerprint {
            transport_running: self.transport_running,
            startup_frame_ticks: self.startup_frame_ticks,
            hovered_content_rating_filter_level: self.hovered_content_rating_filter_level,
            hovered_content_recency_filter_chip: self.hovered_content_recency_filter_chip,
            hovered_content_marked_filter: self.hovered_content_marked_filter,
            ...
            hovered_content_search_field: self.hovered_content_search_field,
            hovered_waveform_toolbar_hint: self.hovered_waveform_toolbar_hint,
