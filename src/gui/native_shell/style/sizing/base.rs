...
pub(super) fn base_sizing() -> SizingTokens {
    SizingTokens {
        ...
        content_tabs_height: 17.0,
        content_tabs_min_height: 16.0,
        browser_toolbar_height: 18.0,
        browser_toolbar_min_height: 18.0,
        content_table_header_height: 17.0,
        content_table_header_min_height: 16.0,
        content_footer_height: 14.5,
        content_footer_min_height: 14.0,
        content_footer_max_height: 28.0,
