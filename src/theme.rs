...
impl ThemeTokens {
    ...
    fn dark_base() -> Self {
        Self {
            clear_color: rgba(18, 22, 25, 255),
            bg_primary: rgba(14, 18, 21, 255),
            bg_secondary: rgba(20, 25, 29, 255),
            bg_tertiary: rgba(28, 34, 39, 255),
            surface_base: rgba(17, 22, 26, 255),
            surface_raised: rgba(27, 33, 38, 255),
            surface_overlay: rgba(36, 43, 49, 255),
            border: rgba(49, 59, 67, 255),
            border_emphasis: rgba(89, 104, 116, 255),
            grid_strong: rgba(69, 82, 93, 255),
            grid_soft: rgba(35, 43, 49, 255),
            accent_mint: rgba(239, 83, 58, 255),
            accent_copper: rgba(255, 115, 78, 255),
            accent_danger: rgba(255, 83, 48, 255),
            accent_warning: rgba(255, 155, 79, 255),
            highlight_orange: rgba(255, 94, 59, 255),
            highlight_orange_soft: rgba(245, 138, 102, 255),
            highlight_blue: rgba(118, 146, 164, 255),
            highlight_blue_soft: rgba(95, 111, 124, 255),
            highlight_cyan: rgba(118, 180, 174, 255),
            highlight_cyan_soft: rgba(102, 141, 140, 255),
            text_primary: rgba(236, 239, 241, 255),
            text_muted: rgba(139, 149, 157, 255),
            control_disabled_fill: rgba(31, 37, 42, 255),
            state_hover_soft: 0.12,
            state_hover_strong: 0.20,
            state_selected_blend: 0.12,
            state_focus_pulse_blend: 0.24,
