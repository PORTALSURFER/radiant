...
pub(in crate::application) type AppDeclarativeCommandRouter<Message> =
    crate::application::CommandService<Message>;
...
pub(in crate::application) struct AppBridgeLifecycle<State, Message> {
    ...
    /// Native main-window focus-regained observer.
    pub(in crate::application) native_focus_regained:
        Option<AppNativeFocusRegained<State, Message>>,
    /// Native frame diagnostics observer.
