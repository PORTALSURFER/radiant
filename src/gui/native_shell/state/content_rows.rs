...
pub(super) struct ContentRowsCacheKey {
    ...
    pub(super) root_max_x: u32,
    pub(super) root_max_y: u32,
    pub(super) content_rows_min_x: u32,
    pub(super) content_rows_min_y: u32,
    pub(super) content_rows_max_x: u32,
    pub(super) content_rows_max_y: u32,
    pub(super) content_row_height: u32,
    pub(super) content_row_gap: u32,
    pub(super) content_rows_max_per_column: u32,
    pub(super) row_capacity: u32,
    pub(super) content_row_count: u32,
