...
impl crate::widgets::WidgetSemanticActions for ButtonWidget {
    ...
    fn supports(&self, action: &crate::widgets::SemanticAction) -> bool {
        matches!(action, crate::widgets::SemanticAction::Press)
    }
    fn dispatch(
        &mut self,
        ...
        crate::widgets::WidgetSemanticActionResult::Accepted(Some(
            crate::widgets::WidgetOutput::typed(crate::widgets::ButtonMessage::Activate {
