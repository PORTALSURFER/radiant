...
fn gpu_surface_visible_suffix_regions_reuse_scratch_storage() {
    ...
    let mut scratch = SurfaceVisibleSuffixScratch {
        ...
        query_stats: SurfaceOcclusionQueryStats::default(),
        gpu_surfaces_planned: 0,
        visible_gpu_surfaces: 0,
    };
...
fn gpu_surface_visible_suffix_regions_skip_nonfinite_surface_rects() {
    ...
    surface.rect = UiRect::from_min_max(Point::new(f32::NEG_INFINITY, 0.0), Point::new(1.0, 1.0));
    let mut regions = Vec::new();
