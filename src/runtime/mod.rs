...
pub use controller::{
    CommandOutcome, Event, FocusTraversal, RuntimeContext, RuntimeSurfaceFrame, SurfaceRuntime,
};
pub use gpu_surface::{
...
pub use paint::{
    ...
    PaintText, PaintTextAlign, PaintTextInput, PaintTextRun, Renderer, SurfacePaintPlan,
    SurfacePaintStats,
};
pub(crate) use paint::{
