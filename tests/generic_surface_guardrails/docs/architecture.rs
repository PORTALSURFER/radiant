...
fn architecture_map_documents_target_aligned_boundaries() {
    ...
    for required in [
        ...
        "terminal copy-or-cancel result asynchronously",
        ...
        "macOS-only AppKit file-drag implementation",
        ...
        "Windows-only OLE file-drag implementation",
        "reachable only through the cfg-gated platform adapter",
        ...
        "accidental Windows-only imports",
        "target-specific dependency leakage",
