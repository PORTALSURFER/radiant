...
#[derive(Clone, Copy, Debug, PartialEq)]
pub(super) struct WaveformScrollbarLayout {
...
pub(super) fn waveform_scrollbar_layout(
    waveform_plot: Rect,
...
pub(super) fn waveform_scrollbar_center_for_pointer(
...
pub(super) fn playhead_marker_rect(
    waveform_plot: Rect,
    border_width: f32,
    model: &NativeMotionModel,
) -> Option<Rect> {
