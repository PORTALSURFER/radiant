...
fn browser_segment_text_cache_key(
    ...
    BrowserSegmentTextCacheKey {
        ...
        content_footer_min_x: f32_to_bits(layout.browser_footer.min.x),
        content_footer_min_y: f32_to_bits(layout.browser_footer.min.y),
        content_footer_max_x: f32_to_bits(layout.browser_footer.max.x),
        content_footer_max_y: f32_to_bits(layout.browser_footer.max.y),
