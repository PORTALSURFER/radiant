...
pub(crate) struct NativeShellState {
    ...
    hovered_content_search_field: bool,
    content_search_editor_visual: Option<TextFieldVisualState>,
    content_pill_editor_visual: Option<TextFieldVisualState>,
    ...
    content_rows: Vec<CachedContentRow>,
    content_rows_window_start: usize,
    content_rows_cache_key: Option<ContentRowsCacheKey>,
    ...
    content_action_buttons: Vec<ActionButton>,
    content_column_chips: Vec<ColumnChip>,
    content_toolbar_layout: Option<ContentToolbarLayout>,
    content_action_hit_test_cache_key: Option<ContentActionHitTestCacheKey>,
    ...
    content_segment_text_cache: Option<Arc<ContentSegmentTextCacheValue>>,
    content_segment_text_cache_key: Option<ContentSegmentTextCacheKey>,
    content_segment_text_frame_counts: SegmentTextCacheFrameCounts,
    content_row_truncation_cache: ContentRowTruncationCache,
    content_row_truncation_cache_key: Option<ContentRowTruncationCacheKey>,
    content_row_truncation_frame_counts: ContentRowTruncationFrameCounts,
...
impl NativeShellState {
    ...
    pub(crate) fn new() -> Self {
        Self {
            ...
            hovered_content_search_field: false,
            content_search_editor_visual: None,
            content_pill_editor_visual: None,
            ...
            content_rows_window_start: 0,
            content_rows_cache_key: None,
            content_list_scrollbar: None,
            content_list_scrollbar_viewport_len: 0,
            content_list_scrollbar_cache_key: None,
            content_action_buttons: Vec::new(),
            content_column_chips: Vec::new(),
            content_toolbar_layout: None,
            content_action_hit_test_cache_key: None,
            waveform_toolbar_buttons: Vec::new(),
            waveform_toolbar_hit_test_cache_key: None,
            content_segment_text_cache: None,
            content_segment_text_cache_key: None,
            content_segment_text_frame_counts: SegmentTextCacheFrameCounts::default(),
            content_row_truncation_cache: ContentRowTruncationCache::default(),
            content_row_truncation_cache_key: None,
            content_row_truncation_frame_counts: ContentRowTruncationFrameCounts::default(),
